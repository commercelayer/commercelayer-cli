...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/v2.4.1/src/commands/plugins/inspect.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/v2.4.1/src/commands/plugins/install.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/v2.4.1/src/commands/plugins/link.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/v2.4.1/src/commands/plugins/uninstall.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/v2.4.1/src/commands/plugins/update.ts)_
