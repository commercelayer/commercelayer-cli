...
_See code: [src/commands/applications.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.5.10/src/commands/applications.ts)_
...
_See code: [src/commands/applications/current.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.5.10/src/commands/applications/current.ts)_
...
_See code: [src/commands/applications/login.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.5.10/src/commands/applications/login.ts)_
...
_See code: [src/commands/applications/token.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.5.10/src/commands/applications/token.ts)_
