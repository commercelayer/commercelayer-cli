import { CLIError, error, exit, warn } from '@oclif/core/lib/errors'
...
import { Command, CompletableOptionFlag, Hook, Hooks, PJSON, Topic } from '@oclif/core/lib/interfaces'
import * as Plugin from '@oclif/core/lib/config/plugin'
import { Debug, compact, loadJSON, collectUsableIds, getCommandIdPermutations } from '@oclif/core/lib/config/util'
import { isProd } from '@oclif/core/lib/util'
