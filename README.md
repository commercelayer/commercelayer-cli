...
@commercelayer/commercelayer-cli/0.0.25 darwin-x64 node-v15.13.0
...
_See code: [src/commands/applications/current.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.0.25/src/commands/applications/current.ts)_
...
_See code: [src/commands/applications/list.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.0.25/src/commands/applications/list.ts)_
...
_See code: [src/commands/applications/login.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.0.25/src/commands/applications/login.ts)_
...
_See code: [src/commands/applications/token.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.0.25/src/commands/applications/token.ts)_
...
_See code: [src/commands/plugins/available.ts](https://github.com/commercelayer/commercelayer-cli/blob/v0.0.25/src/commands/plugins/available.ts)_
